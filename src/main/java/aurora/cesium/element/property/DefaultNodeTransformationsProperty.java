 ...
 * @date 2020/8/28
 */
public class DefaultNodeTransformationsProperty extends PropertyAdapter<NodeTransformationsProperty> implements NodeTransformationsProperty {
    ...
    public static final class Builder {
        ...
        public DefaultNodeTransformationsProperty build() {
            DefaultNodeTransformationsProperty defaultNodeTransformationsProperty = new DefaultNodeTransformationsProperty();
            defaultNodeTransformationsProperty.setNodeTransformations(nodeTransformations);
            defaultNodeTransformationsProperty.setInterval(interval);
            defaultNodeTransformationsProperty.setIntervals(intervals);
            return defaultNodeTransformationsProperty;
        }
    }
}
