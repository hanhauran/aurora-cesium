...
class RgbaColorPropertyImpl extends SingleTimeBasedPropertyAdapter<Color, ColorProperty> implements ColorProperty {
    ...
    public static final class Builder {
        ...
        public RgbaColorPropertyImpl build() {
            RgbaColorPropertyImpl rgbaColorPropertyImpl = new RgbaColorPropertyImpl();
            rgbaColorPropertyImpl.setDates(dates);
            rgbaColorPropertyImpl.setValues(values);
            ...
            rgbaColorPropertyImpl.setReference(reference);
            return rgbaColorPropertyImpl;
        }
    }
}
