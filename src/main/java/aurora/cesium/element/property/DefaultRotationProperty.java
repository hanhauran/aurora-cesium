 ...
 * @date 2020/8/28
 */
public class DefaultRotationProperty extends PropertyAdapter<RotationProperty> implements RotationProperty {
    ...
    public static final class Builder {
        ...
        public DefaultRotationProperty build() {
            DefaultRotationProperty defaultRotationProperty = new DefaultRotationProperty();
            defaultRotationProperty.setUnitQuaternion(unitQuaternion);
            defaultRotationProperty.setInterpolations(interpolations);
            defaultRotationProperty.setInterval(interval);
            defaultRotationProperty.setIntervals(intervals);
            defaultRotationProperty.setReference(reference);
            return defaultRotationProperty;
        }
    }
}
