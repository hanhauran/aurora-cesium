 ...
 * @date 2020/8/20
 */
abstract class BaseSingleInterpolatableProperty<T> extends BaseSingleProperty<T> implements Property, InterpolatableProperty {
    ...
    public BaseSingleInterpolatableProperty() {
        super();
    }

    public BaseSingleInterpolatableProperty(T instance) {
        super(instance);
    }
