 ...
 * @date 2020/8/28
 */
public class DefaultTranslationProperty extends PropertyAdapter<TranslationProperty> implements TranslationProperty {
    ...
    public static final class Builder {
        ...
        public DefaultTranslationProperty build() {
            DefaultTranslationProperty defaultTranslationProperty = new DefaultTranslationProperty();
            defaultTranslationProperty.setCartesian(cartesian);
            defaultTranslationProperty.setInterpolations(interpolations);
            defaultTranslationProperty.setInterval(interval);
            defaultTranslationProperty.setIntervals(intervals);
            defaultTranslationProperty.setReference(reference);
            return defaultTranslationProperty;
        }
    }
}
