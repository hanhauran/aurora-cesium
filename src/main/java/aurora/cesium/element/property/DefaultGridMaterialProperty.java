 ...
 * @date 2020/8/28
 */
public class DefaultGridMaterialProperty extends PropertyAdapter<GridMaterialProperty> implements GridMaterialProperty {
    ...
    @Override
    public void dispatch(GridMaterialCesiumWriter writer) {
        try (writer) {
    ...
    public static final class Builder {
        ...
        public DefaultGridMaterialProperty build() {
            DefaultGridMaterialProperty defaultGridMaterialProperty = new DefaultGridMaterialProperty();
            defaultGridMaterialProperty.setCellAlpha(cellAlpha);
            defaultGridMaterialProperty.setColor(color);
            defaultGridMaterialProperty.setLineCount(lineCount);
            defaultGridMaterialProperty.setLineOffset(lineOffset);
            defaultGridMaterialProperty.setLineThickness(lineThickness);
            defaultGridMaterialProperty.setInterval(interval);
            defaultGridMaterialProperty.setIntervals(intervals);
            return defaultGridMaterialProperty;
        }
    }
}
