 ...
 * @date 2020/8/28
 */
public class DefaultLineCountProperty extends PropertyAdapter<LineCountProperty> implements LineCountProperty {
    ...
    public static final class Builder {
        ...
        public DefaultLineCountProperty build() {
            DefaultLineCountProperty defaultLineCountProperty = new DefaultLineCountProperty();
            defaultLineCountProperty.setRectangular(rectangular);
            defaultLineCountProperty.setInterpolations(interpolations);
            defaultLineCountProperty.setInterval(interval);
            defaultLineCountProperty.setIntervals(intervals);
            defaultLineCountProperty.setReference(reference);
            return defaultLineCountProperty;
        }
    }
}
