...
public class GridMaterialCesiumWriter extends CesiumPropertyWriter<GridMaterialCesiumWriter> {
    ...
    */
    ...
    private Lazy<DoubleCesiumWriter> m_cellAlpha = new Lazy<DoubleCesiumWriter>(new Func1<DoubleCesiumWriter>() {
        public DoubleCesiumWriter invoke() {
            return new DoubleCesiumWriter(CellAlphaPropertyName);
        }
    }, false);
    private Lazy<LineCountCesiumWriter> m_lineCount = new Lazy<LineCountCesiumWriter>(new Func1<LineCountCesiumWriter>() {
        public LineCountCesiumWriter invoke() {
            return new LineCountCesiumWriter(LineCountPropertyName);
        }
    }, false);
    private Lazy<LineThicknessCesiumWriter> m_lineThickness = new Lazy<LineThicknessCesiumWriter>(new Func1<LineThicknessCesiumWriter>() {
        public LineThicknessCesiumWriter invoke() {
            return new LineThicknessCesiumWriter(LineThicknessPropertyName);
        }
    }, false);
    private Lazy<LineOffsetCesiumWriter> m_lineOffset = new Lazy<LineOffsetCesiumWriter>(new Func1<LineOffsetCesiumWriter>() {
