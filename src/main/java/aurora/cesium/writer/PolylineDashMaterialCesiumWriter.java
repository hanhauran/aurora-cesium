...
public class PolylineDashMaterialCesiumWriter extends CesiumPropertyWriter<PolylineDashMaterialCesiumWriter> {
    ...
    */
    ...
    private Lazy<ColorCesiumWriter> m_gapColor = new Lazy<ColorCesiumWriter>(new Func1<ColorCesiumWriter>() {
        public ColorCesiumWriter invoke() {
            return new ColorCesiumWriter(GapColorPropertyName);
        }
    }, false);
    private Lazy<DoubleCesiumWriter> m_dashLength = new Lazy<DoubleCesiumWriter>(new Func1<DoubleCesiumWriter>() {
        public DoubleCesiumWriter invoke() {
            return new DoubleCesiumWriter(DashLengthPropertyName);
        }
    }, false);
    private Lazy<IntegerCesiumWriter> m_dashPattern = new Lazy<IntegerCesiumWriter>(new Func1<IntegerCesiumWriter>() {
