...
public class ColorCesiumWriter extends CesiumInterpolatablePropertyWriter<ColorCesiumWriter> implements ICesiumDeletablePropertyWriter, ICesiumRgbaValuePropertyWriter,
    ...
    */
    ...
    private final Lazy<CesiumRgbaValuePropertyAdaptor<ColorCesiumWriter>> createAsRgba() {
        return new Lazy<CesiumRgbaValuePropertyAdaptor<ColorCesiumWriter>>(new Func1<CesiumRgbaValuePropertyAdaptor<ColorCesiumWriter>>(
                this, "createRgba") {
    ...
    */
    ...
    private final Lazy<CesiumRgbafValuePropertyAdaptor<ColorCesiumWriter>> createAsRgbaf() {
        return new Lazy<CesiumRgbafValuePropertyAdaptor<ColorCesiumWriter>>(new Func1<CesiumRgbafValuePropertyAdaptor<ColorCesiumWriter>>(
                this, "createRgbaf") {
    ...
    */
    ...
    private final Lazy<CesiumReferenceValuePropertyAdaptor<ColorCesiumWriter>> createAsReference() {
        return new Lazy<CesiumReferenceValuePropertyAdaptor<ColorCesiumWriter>>(
                new Func1<CesiumReferenceValuePropertyAdaptor<ColorCesiumWriter>>(this, "createReference") {
