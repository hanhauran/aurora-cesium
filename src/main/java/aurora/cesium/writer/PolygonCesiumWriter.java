...
public class PolygonCesiumWriter extends CesiumPropertyWriter<PolygonCesiumWriter> {
    ...
    */
    ...
    private Lazy<PositionListOfListsCesiumWriter> m_holes = new Lazy<PositionListOfListsCesiumWriter>(new Func1<PositionListOfListsCesiumWriter>() {
    ...
    private Lazy<HeightReferenceCesiumWriter> m_extrudedHeightReference = new Lazy<HeightReferenceCesiumWriter>(new Func1<HeightReferenceCesiumWriter>() {
        public HeightReferenceCesiumWriter invoke() {
    ...
    private Lazy<BooleanCesiumWriter> m_closeTop = new Lazy<BooleanCesiumWriter>(new Func1<BooleanCesiumWriter>() {
        public BooleanCesiumWriter invoke() {
            return new BooleanCesiumWriter(CloseTopPropertyName);
        }
    }, false);
    private Lazy<BooleanCesiumWriter> m_closeBottom = new Lazy<BooleanCesiumWriter>(new Func1<BooleanCesiumWriter>() {
        public BooleanCesiumWriter invoke() {
