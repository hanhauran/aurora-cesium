...
public class VectorCesiumWriter extends CesiumPropertyWriter<VectorCesiumWriter> {
    ...
    */
    ...
    private Lazy<DirectionCesiumWriter> m_direction = new Lazy<DirectionCesiumWriter>(new Func1<DirectionCesiumWriter>() {
    ...
    private Lazy<DoubleCesiumWriter> m_minimumLengthInPixels = new Lazy<DoubleCesiumWriter>(new Func1<DoubleCesiumWriter>() {
        public DoubleCesiumWriter invoke() {
