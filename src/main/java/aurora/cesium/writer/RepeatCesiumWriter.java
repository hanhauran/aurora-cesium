...
public class RepeatCesiumWriter extends CesiumInterpolatablePropertyWriter<RepeatCesiumWriter> implements ICesiumDeletablePropertyWriter, ICesiumCartesian2ValuePropertyWriter,
    ...
    */
    ...
    private final Lazy<CesiumCartesian2ValuePropertyAdaptor<RepeatCesiumWriter>> createAsCartesian2() {
        return new Lazy<CesiumCartesian2ValuePropertyAdaptor<RepeatCesiumWriter>>(
                new Func1<CesiumCartesian2ValuePropertyAdaptor<RepeatCesiumWriter>>(this, "createCartesian2") {
    ...
    */
    ...
    private final Lazy<CesiumReferenceValuePropertyAdaptor<RepeatCesiumWriter>> createAsReference() {
        return new Lazy<CesiumReferenceValuePropertyAdaptor<RepeatCesiumWriter>>(
                new Func1<CesiumReferenceValuePropertyAdaptor<RepeatCesiumWriter>>(this, "createReference") {
