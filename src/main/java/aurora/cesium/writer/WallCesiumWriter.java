...
public class WallCesiumWriter extends CesiumPropertyWriter<WallCesiumWriter> {
    ...
    */
    ...
    private Lazy<DoubleListCesiumWriter> m_minimumHeights = new Lazy<DoubleListCesiumWriter>(new Func1<DoubleListCesiumWriter>() {
        public DoubleListCesiumWriter invoke() {
            return new DoubleListCesiumWriter(MinimumHeightsPropertyName);
        }
    }, false);
    private Lazy<DoubleListCesiumWriter> m_maximumHeights = new Lazy<DoubleListCesiumWriter>(new Func1<DoubleListCesiumWriter>() {
        public DoubleListCesiumWriter invoke() {
