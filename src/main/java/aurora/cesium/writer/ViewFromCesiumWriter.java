...
public class ViewFromCesiumWriter extends CesiumInterpolatablePropertyWriter<ViewFromCesiumWriter> implements ICesiumDeletablePropertyWriter, ICesiumCartesian3ValuePropertyWriter,
    ...
    */
    ...
    private final Lazy<CesiumCartesian3ValuePropertyAdaptor<ViewFromCesiumWriter>> createAsCartesian() {
        return new Lazy<CesiumCartesian3ValuePropertyAdaptor<ViewFromCesiumWriter>>(
                new Func1<CesiumCartesian3ValuePropertyAdaptor<ViewFromCesiumWriter>>(this, "createCartesian3") {
    ...
    */
    ...
    private final Lazy<CesiumReferenceValuePropertyAdaptor<ViewFromCesiumWriter>> createAsReference() {
        return new Lazy<CesiumReferenceValuePropertyAdaptor<ViewFromCesiumWriter>>(
                new Func1<CesiumReferenceValuePropertyAdaptor<ViewFromCesiumWriter>>(this, "createReference") {
