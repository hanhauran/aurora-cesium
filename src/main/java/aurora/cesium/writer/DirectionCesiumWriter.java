...
import aurora.cesium.writer.advanced.*;
    ...
    */
    ...
    private final Lazy<CesiumSphericalValuePropertyAdaptor<DirectionCesiumWriter>> createAsSpherical() {
        return new Lazy<CesiumSphericalValuePropertyAdaptor<DirectionCesiumWriter>>(
                new Func1<CesiumSphericalValuePropertyAdaptor<DirectionCesiumWriter>>(this, "createSpherical") {
    ...
    */
    ...
    private final Lazy<CesiumUnitSphericalValuePropertyAdaptor<DirectionCesiumWriter>> createAsUnitSpherical() {
        return new Lazy<CesiumUnitSphericalValuePropertyAdaptor<DirectionCesiumWriter>>(
                new Func1<CesiumUnitSphericalValuePropertyAdaptor<DirectionCesiumWriter>>(this, "createUnitSpherical") {
    ...
    */
    ...
    private final Lazy<CesiumCartesian3ValuePropertyAdaptor<DirectionCesiumWriter>> createAsCartesian() {
        return new Lazy<CesiumCartesian3ValuePropertyAdaptor<DirectionCesiumWriter>>(
                new Func1<CesiumCartesian3ValuePropertyAdaptor<DirectionCesiumWriter>>(this, "createCartesian3") {
    ...
    */
    ...
    private final Lazy<CesiumUnitCartesian3ValuePropertyAdaptor<DirectionCesiumWriter>> createAsUnitCartesian() {
        return new Lazy<CesiumUnitCartesian3ValuePropertyAdaptor<DirectionCesiumWriter>>(
                new Func1<CesiumUnitCartesian3ValuePropertyAdaptor<DirectionCesiumWriter>>(this, "createUnitCartesian3") {
    ...
    */
    ...
    private final Lazy<CesiumReferenceValuePropertyAdaptor<DirectionCesiumWriter>> createAsReference() {
        return new Lazy<CesiumReferenceValuePropertyAdaptor<DirectionCesiumWriter>>(
                new Func1<CesiumReferenceValuePropertyAdaptor<DirectionCesiumWriter>>(this, "createReference") {
