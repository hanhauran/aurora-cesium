...
public class CylinderCesiumWriter extends CesiumPropertyWriter<CylinderCesiumWriter> {
    ...
    */
    ...
    private Lazy<DoubleCesiumWriter> m_length = new Lazy<DoubleCesiumWriter>(new Func1<DoubleCesiumWriter>() {
        public DoubleCesiumWriter invoke() {
            return new DoubleCesiumWriter(LengthPropertyName);
        }
    }, false);
    private Lazy<DoubleCesiumWriter> m_topRadius = new Lazy<DoubleCesiumWriter>(new Func1<DoubleCesiumWriter>() {
        public DoubleCesiumWriter invoke() {
            return new DoubleCesiumWriter(TopRadiusPropertyName);
        }
    }, false);
    private Lazy<DoubleCesiumWriter> m_bottomRadius = new Lazy<DoubleCesiumWriter>(new Func1<DoubleCesiumWriter>() {
        public DoubleCesiumWriter invoke() {
    ...
    private Lazy<IntegerCesiumWriter> m_numberOfVerticalLines = new Lazy<IntegerCesiumWriter>(new Func1<IntegerCesiumWriter>() {
        public IntegerCesiumWriter invoke() {
            return new IntegerCesiumWriter(NumberOfVerticalLinesPropertyName);
        }
    }, false);
    private Lazy<IntegerCesiumWriter> m_slices = new Lazy<IntegerCesiumWriter>(new Func1<IntegerCesiumWriter>() {
        public IntegerCesiumWriter invoke() {
