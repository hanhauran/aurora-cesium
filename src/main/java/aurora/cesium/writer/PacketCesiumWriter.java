...
import aurora.cesium.agi.foundation.compatibility.DisposeHelper;
import aurora.cesium.agi.foundation.compatibility.Func1;
import aurora.cesium.agi.foundation.compatibility.Lazy;
import aurora.cesium.writer.advanced.CesiumElementWriter;
import aurora.cesium.writer.advanced.CesiumWritingHelper;
...
public class PacketCesiumWriter extends CesiumElementWriter {
    ...
    */
    ...
    private Lazy<StringCesiumWriter> m_description = new Lazy<StringCesiumWriter>(new Func1<StringCesiumWriter>() {
        public StringCesiumWriter invoke() {
            return new StringCesiumWriter(DescriptionPropertyName);
        }
    }, false);
    private Lazy<ClockCesiumWriter> m_clock = new Lazy<ClockCesiumWriter>(new Func1<ClockCesiumWriter>() {
        public ClockCesiumWriter invoke() {
            return new ClockCesiumWriter(ClockPropertyName);
        }
    }, false);
    private Lazy<CustomPropertiesCesiumWriter> m_properties = new Lazy<CustomPropertiesCesiumWriter>(new Func1<CustomPropertiesCesiumWriter>() {
    ...
    private Lazy<ViewFromCesiumWriter> m_viewFrom = new Lazy<ViewFromCesiumWriter>(new Func1<ViewFromCesiumWriter>() {
    ...
    private Lazy<BoxCesiumWriter> m_box = new Lazy<BoxCesiumWriter>(new Func1<BoxCesiumWriter>() {
        public BoxCesiumWriter invoke() {
            return new BoxCesiumWriter(BoxPropertyName);
        }
    }, false);
    private Lazy<CorridorCesiumWriter> m_corridor = new Lazy<CorridorCesiumWriter>(new Func1<CorridorCesiumWriter>() {
        public CorridorCesiumWriter invoke() {
            return new CorridorCesiumWriter(CorridorPropertyName);
        }
    }, false);
    private Lazy<CylinderCesiumWriter> m_cylinder = new Lazy<CylinderCesiumWriter>(new Func1<CylinderCesiumWriter>() {
        public CylinderCesiumWriter invoke() {
            return new CylinderCesiumWriter(CylinderPropertyName);
        }
    }, false);
    private Lazy<EllipseCesiumWriter> m_ellipse = new Lazy<EllipseCesiumWriter>(new Func1<EllipseCesiumWriter>() {
        public EllipseCesiumWriter invoke() {
            return new EllipseCesiumWriter(EllipsePropertyName);
        }
    }, false);
    private Lazy<EllipsoidCesiumWriter> m_ellipsoid = new Lazy<EllipsoidCesiumWriter>(new Func1<EllipsoidCesiumWriter>() {
    ...
    private Lazy<ModelCesiumWriter> m_model = new Lazy<ModelCesiumWriter>(new Func1<ModelCesiumWriter>() {
    ...
    private Lazy<RectangleCesiumWriter> m_rectangle = new Lazy<RectangleCesiumWriter>(new Func1<RectangleCesiumWriter>() {
        public RectangleCesiumWriter invoke() {
            return new RectangleCesiumWriter(RectanglePropertyName);
        }
    }, false);
    private Lazy<TilesetCesiumWriter> m_tileset = new Lazy<TilesetCesiumWriter>(new Func1<TilesetCesiumWriter>() {
        public TilesetCesiumWriter invoke() {
            return new TilesetCesiumWriter(TilesetPropertyName);
        }
    }, false);
    private Lazy<WallCesiumWriter> m_wall = new Lazy<WallCesiumWriter>(new Func1<WallCesiumWriter>() {
        public WallCesiumWriter invoke() {
            return new WallCesiumWriter(WallPropertyName);
        }
    }, false);
    private Lazy<ConicSensorCesiumWriter> m_agi_conicSensor = new Lazy<ConicSensorCesiumWriter>(new Func1<ConicSensorCesiumWriter>() {
        public ConicSensorCesiumWriter invoke() {
            return new ConicSensorCesiumWriter(ConicSensorPropertyName);
        }
    }, false);
    private Lazy<CustomPatternSensorCesiumWriter> m_agi_customPatternSensor = new Lazy<CustomPatternSensorCesiumWriter>(
            new Func1<CustomPatternSensorCesiumWriter>() {
                public CustomPatternSensorCesiumWriter invoke() {
                    return new CustomPatternSensorCesiumWriter(CustomPatternSensorPropertyName);
                }
            }, false);
    private Lazy<RectangularSensorCesiumWriter> m_agi_rectangularSensor = new Lazy<RectangularSensorCesiumWriter>(new Func1<RectangularSensorCesiumWriter>() {
        public RectangularSensorCesiumWriter invoke() {
            return new RectangularSensorCesiumWriter(RectangularSensorPropertyName);
        }
    }, false);
    private Lazy<FanCesiumWriter> m_agi_fan = new Lazy<FanCesiumWriter>(new Func1<FanCesiumWriter>() {
        public FanCesiumWriter invoke() {
            return new FanCesiumWriter(FanPropertyName);
        }
    }, false);
    private Lazy<VectorCesiumWriter> m_agi_vector = new Lazy<VectorCesiumWriter>(new Func1<VectorCesiumWriter>() {
