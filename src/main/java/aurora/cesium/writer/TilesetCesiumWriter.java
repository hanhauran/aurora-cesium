...
public class TilesetCesiumWriter extends CesiumPropertyWriter<TilesetCesiumWriter> {
    ...
    */
    ...
    private Lazy<UriCesiumWriter> m_uri = new Lazy<UriCesiumWriter>(new Func1<UriCesiumWriter>() {
        public UriCesiumWriter invoke() {
            return new UriCesiumWriter(UriPropertyName);
        }
    }, false);
    private Lazy<DoubleCesiumWriter> m_maximumScreenSpaceError = new Lazy<DoubleCesiumWriter>(new Func1<DoubleCesiumWriter>() {
